...
evaluate-commands %sh{
	...
	base2='rgb:eee8d5'
	base3='rgb:fdf6e3'
	yellow='rgb:F4BF75'		#base0A
	orange='rgb:D28445'		#base09
	red='rgb:AC4142'		#base08
	magenta='rgb:AA759F'	#base0E
	violet='rgb:6c71c4'
	blue='rgb:6A9FB5'		#base0D
	cyan='rgb:75B5AA'		#base0C
	green='rgb:90A959'		#base0B
